...
def upgrade() -> None:
    ...
    for table in ("lead_criteria_snapshots", "research_search_plans", "research_runs", "entity_resolution_runs", "verification_runs", "lead_scores", "verified_lead_sets"):
...
def downgrade() -> None:
    for table in ("verified_lead_sets", "lead_scores", "verification_runs", "entity_resolution_runs", "research_runs", "research_search_plans", "lead_criteria_snapshots"):
